...
<main id="main" class="container">
    <form action="pages/xulythanhtoan.php" method="POST" class="page-payment">
                ...
                <div class="shipping-in4">
                    <div class="payment-methods">
                        ...
                        <div class="pay cod inp-pay">
                            <div>
                                <input type="radio" id="cash-on-delivery" name="payment-method" value="thanh toán tiền mặt" style="cursor: pointer;" />
                        ...
                        <div class=" inp-pay">
                            <div class="pay ">
                                <div>
                                    <input type="radio" id="bank-transfer" name="payment-method" value="chuyển khoản" style="cursor: pointer;" />
                            ...
                            <div class="atm-banking-in4" style="text-align: center; ">
                                ...
                                <br>
                                <p><b>QR CODE :</b></p>
                                <img src="./images/banking/bankking.jpg" alt="" style="width: 250px; height:250px ;border: 1px solid #cfcfcf">
                            </div>
                        </div>
        ...
        <div class="column-right-pay">
            <h3 style="padding: 15px 0;"><?php echo "Đơn hàng ($numberOfItems sản phẩm)   "; ?></h3>
            <hr>
            <br>
                ...
                ?>
                        <div class="box-prd-pay">
                            ...
                            <div class="price-prd-pay">
                                <span><?php echo number_format($product['gia'] * $product['soluong'], 0, ',', '.'); ?>
                                    .000 VNĐ</span>
                            </div>
                        </div>
                    <?php
            ...
            <div class="count-payment">
                <p class="count tamtinh">Tạm tính <span><?php echo number_format($total_price) ?>.000 VNĐ</span></p>
                <p class="count phivanchuyen">Phí vận chuyển <span>_</span></p>
            </div>
            <br>
            <hr class="hr" />
            <div class="total-payment">
                <p>Tổng Cộng: <span><?php echo $tongtien ?> .000 VNĐ</span></p>
            </div>
            <div class="return-to-cart">
                ...
                <input type="submit" class="order" value="Đặt Hàng">
            </div>
        </div>
    </form>
</main>