<div id="main" class="container">
     ...
     <div class="user-flex">
            ...
            ?>
               ...
               <a href="index.php?action=account&view=<?php echo $action; ?>">
                    <div class="flex-select <?php if ($view === $action) echo 'selected'; ?>">
                         <i
                              class='bx <?php echo $action === "account" ? "bx-user" : ($action === "donhang" ? "bx-file" : ($action === "sodiachi" ? "bx-map" : "bx-lock-alt")); ?>'></i>
                         <p><?php echo $text; ?></p>
                    </div>
               </a>
               <?php endforeach; ?>
        ...
        if (isset($_SESSION['dangnhap'])) {
            $sql = "SELECT * FROM loginuser WHERE HoTen = '" . $_SESSION['dangnhap'] . "'";
        ...
        ?>
          ...
          <div class="user-profile">
               <h1>Hồ sơ của tôi</h1>
               <form action="pages/xulyuser-profile.php?user-id=<?php echo $email ?>" method="post">
                    ...
                    <div class="user-input">
                         ...
                         <input type="text" name="phone-user" value="<?php echo $sodienthoai ? $sodienthoai : '' ?>"
                              required>
                    </div>
          ...
          <div class="user-profile">
               ...
               <form action="pages/xulyuser-profile.php?user-id=<?php echo $email ?>" method="post">
                    ...
                    <div class="user-input">
                         ...
                         <input type="text" name="check-pass" placeholder="Xác nhận lại mật khẩu" autocomplete="off"
                              required>
                    </div>
