...
if (isset($_POST['login'])) {
    ...
    $sql = "SELECT * FROM loginuser WHERE email = '" . $email . "' AND matkhau = '" . $password . " ' LIMIT 1";
        ...
        <div class="form" style="width: 30%;">
            ...
            <form action="" method="POST" class="form-logup">
                ...
                <div class="ip-logup">
                    ...
                    <input type="email" name="email" class="form-control" placeholder="vd: exmaple@gmail.com" />
                </div>
