               ...
               ?>
                              <tr>
                                   ...
                                   <td>
                                        ...
                                        <select name="status">
                                             <option value="chưa xác nhận" <?php if ($status_class === 'chưa xác nhận') echo 'selected'; ?>>Chưa xác nhận
                                             </option>
                                             <option value="đã xác nhận" <?php if ($status_class === 'đã xác nhận') echo 'selected'; ?>>Đã xác nhận
                                             </option>
                                             <option value="đang giao hàng" <?php if ($status_class === 'đang giao hàng') echo 'selected'; ?>>Đang giao hàng
                                             </option>
                                        </select>
                                   </td>
