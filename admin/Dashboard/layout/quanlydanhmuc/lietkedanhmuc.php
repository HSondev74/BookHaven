               ...
               ?>
                    <tr>
                         ...
                         <td style="margin: 10px 0;">
                              <a href="?action=danhmuc&query=edit&id=<?php echo $row['matheloai'] ?>" style="background-color: orange;
                    color: white;
                    padding: 10px 20px;
                    border: none;
                    border-radius: 4px;
                    ...
                    border: none;
                    border-radius: 4px;
                    cursor: pointer;" href="Dashboard/layout/quanlydanhmuc/xuly.php?id=<?php echo $row['matheloai'] ?>">Xóa</a>
                         </td>
                    </tr>
               <?php } ?>
          </tbody>
