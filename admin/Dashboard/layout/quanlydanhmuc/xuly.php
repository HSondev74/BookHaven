...
if (isset($_POST['btnSave'])) {
   ...
   $sql = "INSERT INTO theloai (Ten) VALUES ('$tendanhmuc')";
   ...
   $sql_sua = "UPDATE theloai set Ten ='" . $tendanhmuc . "',matheloai='" . $id . "' WHERE matheloai='$_GET[id]' ";
...
//    $sql_xoa_sanpham = " DELETE FROM sanpham WHERE matheloai = '" . $id . "' ";
//    $sql_xoa = " DELETE FROM danhmuc WHERE matheloai = '" . $id . "' ";
